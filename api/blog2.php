...
<section class="blog-details">
    ...
    <div class="blog-container">
        ...
        <div class="blog-description">
            ...
            <p>
                Jewellery trends continue to evolve, but some styles remain timeless while adapting to modern fashion. Today’s jewellery focuses on minimal elegance, versatility, and unique detailing. Let’s explore some of the most popular jewellery trends that are loved by women across India.
            </p>

            <h2>1. Minimal and Layered Bracelets</h2>

            <p>
                Minimal bracelets are trending because they are easy to style and comfortable to wear. Many women prefer wearing a single elegant bracelet or layering two or three for a modern look. These bracelets complement both casual and festive outfits beautifully.

            </p>

            <h2>2. Elegant Earrings for Every Occasion</h2>

            <p>
               Earrings are one of the most essential jewellery pieces. From classic studs to stylish drop earrings, lightweight designs are in high demand. Women prefer earrings that can be worn for long hours without discomfort while still making a style statement.
            </p>

            <h2>3. Statement Rings with Fine Detailing</h2>

            <p>
               Rings have evolved from simple accessories to statement pieces. Unique patterns, modern shapes, and elegant finishes are trending. A single well-designed ring can add charm and sophistication to any outfit.
            </p>

            <h2>4. Blend of Traditional and Modern Designs</h2>

            <p>
                Jewellery that combines traditional inspiration with modern aesthetics is gaining popularity. Such designs allow women to enjoy the beauty of classic styles with a contemporary touch.
            </p>

            <p>
                Explore the latest jewellery trends at Sitara Jewels, where each piece is crafted to suit modern fashion while maintaining timeless elegance.
            </p>
