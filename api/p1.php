...
// Database Connection
$cn = mysqli_connect(getenv('DB_HOST') ?: "localhost", getenv('DB_USER') ?: "root", getenv('DB_PASSWORD') ?: "", getenv('DB_NAME_CONTACT') ?: "user1")
...
if($r1)
{
    ...
    echo "<script>window.location='../frontend/contact.php';</script>";
}
