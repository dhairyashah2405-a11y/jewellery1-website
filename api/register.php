...
<body>
 ...
 <!-- Icons -->
        ...
        <div class="user-dropdown-wrap" id="userDropdownWrap">
            ...
            <div class="user-dropdown-menu" id="userDropdownMenu">
                <?php if (isset($_SESSION['username'])): ?>
                    <a href="../backend/logout.php"><i class="fa-solid fa-right-from-bracket" style="margin-right:7px;"></i>Logout</a>
                <?php else: ?>
    ...
    <div class="register-container">
        ...
        <br>
        <form action="../backend/p4.php" method="post">
            First name:
            <input type="text" id="first_name" name="first_name" placeholder="Enter the first name" pattern="[A-Z a-z]+" title="Only letters are allowed" required> <br><br>

            Last name:
            <input type="text" id="last_name" name="last_name" placeholder="Enter the last name" pattern="[A-Z a-z]+" title="Only letters are allowed" required> <br><br>
            
            Username:
            <input type="text" id="username" name="username" placeholder="Enter the username" pattern="[A-Z a-z]+" title="Only letters are allowed" required> <br><br>
            ...
            Confirm Password:
            <div style="position:relative; width:100%;">
                <input type="password" id="confirm_password" name="confirm_password" placeholder="Enter the confirm password" maxlength="8" required style="padding-right:40px;">
                <span onclick="togglePassword('confirm_password','toggleRegEye2')" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);cursor:pointer;color:#9b4d5d;">
                    <i id="toggleRegEye2" class="fa-regular fa-eye"></i>
                </span>
            </div><br><br>
            <input type="submit" value="Submit" style="margin-left: auto;">
