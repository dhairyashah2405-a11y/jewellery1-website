...
<body>
    <div class="container">
        <h1>📦 All Orders</h1>
        <a href="../frontend/home.php" style="display: inline-block; margin: 20px 0; padding: 10px 20px; background: #1a73e8; color: white; text-decoration: none; border-radius: 5px;">← Back to Home</a>
        ...
        <?php else: ?>
            <div style="text-align: center; padding: 50px; background: white; border-radius: 8px;">
                ...
                <a href="../frontend/home.php" style="display: inline-block; margin-top: 20px; padding: 10px 20px; background: #1a73e8; color: white; text-decoration: none; border-radius: 5px;">Continue Shopping</a>
            </div>
        <?php endif; ?>
    </div>
</body>
