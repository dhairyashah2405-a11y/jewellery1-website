...
@media(max-width:768px){
    ...
    @media (max-width: 768px) {
        ...
        footer .footer-accordion-header h3::after { display: none; }
        footer .footer-accordion-icon {
            font-size: 18px;
            color: #954D59;
        ...
        footer .footer-accordion-icon.open { transform: rotate(180deg); }
        footer .footer-accordion-body {
            max-height: 0;
            overflow: hidden;
    ...
    @media (min-width: 769px) {
        footer .footer-accordion-icon { display: none; }
        footer .footer-accordion-body {
            max-height: none !important;
            overflow: visible !important;
            padding: 0 !important;
        }
        footer .footer-accordion-header { display: block; cursor: default; }
    }
...
<!-- blog -->
 <br>
 <h1 style="text-align: center; margin: 5px;">Our Latest Blog</h1>
 <br>
 <!-- BLOG SECTION -->
<section class="blog-section">
    ...
    <div class="blog-card">
        <div class="blog-image">
            <img src="images/16.jpg" alt="Blog 1">
        </div>

        <div class="blog-content">
            <h2>Benefits Of Buying Jewellery Online From A...</h2>

            <p>
                Online jewellery shopping has become increasingly
                popular due to convenience, variety, and accessibility...
            </p>
    ...
    <div class="blog-card">
        <div class="blog-image">
            <img src="images/17.jpg" alt="Blog 2">
        </div>

        <div class="blog-content">
            <h2>Latest Jewellery Trends In Bracelets,...</h2>

            <p>
                Jewellery trends continue to evolve, but some styles
                remain timeless while adapting to modern fashion....
            </p>
    ...
    <div class="blog-card">
        <div class="blog-image">
            <img src="images/18.jpg" alt="Blog 3">
        </div>

        <div class="blog-content">
            <h2>How To Choose The Perfect Jewellery For...</h2>

            <p>
                Jewellery has become an important part of everyday
                fashion. Today, women prefer jewellery that is stylish,...
            </p>
