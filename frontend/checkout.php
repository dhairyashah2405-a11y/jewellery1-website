...
<body>
    <header>
        <div class="navbar">
            <a href="home.php"><div class="logo">My Store</div></a>
            <div class="cart-icon">
    ...
    <form action="../backend/p3.php" method="POST">
    <div class="checkout-container">
        <div class="left-section">
            ...
            <section>
                ...
                <div class="payment-method" style="display: flex; gap: 15px; margin-top: 15px;">
                    ...
                    <label style="display: flex; align-items: center; gap: 4as  px; padding: 12px 20px; border: 1px solid #ddd; border-radius: 6px; cursor: pointer;">
                        <input type="radio" name="payment_method" value="Card"> Credit/Debit card
                    </label>
                </div>
            </section>

            <button type="submit" name="place_order" class="place-order-btn" style="width: 100%; padding: 16px; background: #000; color: #fff; border: none; border-radius: 6px; font-size: 16px; font-weight: 600; cursor: pointer; margin-top: 20px;">
                Complete order
            </button>
        </div>
        ...
        <div class="right-section">
            <div class="order-summary">
                ...
                // Create empty strings for our products
                $product_name = "";
                $product_price = "";
                $product_image = "";
                $product_quantity = "";
                ...
                if(mysqli_num_rows($select_cart) > 0){
                    while($fetch_cart = mysqli_fetch_assoc($select_cart)){
                        ...
                        // Add each product to the string
                        $product_name = $product_name . $fetch_cart['name'] . ", ";
                        $product_price = $product_price . $fetch_cart['price'] . ", ";
                        $product_image = $product_image . $fetch_cart['image'] . ", ";
                        $product_quantity = $product_quantity . $fetch_cart['quantity'] . ", ";
                ?>
                <div class="product-item">
                    <div class="product-info">
                        <div class="product-image-wrapper">
                            <img src="<?php echo $fetch_cart['image']; ?>" alt="<?php echo $fetch_cart['name']; ?>">
                            <span class="quantity-badge"><?php echo $fetch_cart['quantity']; ?></span>
                        </div>
                ...
                <!-- Send all products as simple text strings -->
