...
<div class="search-overlay" id="searchOverlay">
        ...
        <div class="profile-container">
            ...
            <div class="profile-content">
                ...
                <div class="actions-wrapper">
                    ...
                    <a href="../backend/logout.php" class="btn btn-danger"><i class="fa-solid fa-arrow-right-from-bracket"></i> Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const productsList = [
            <?php
            $res_js = mysqli_query($conn, "SELECT name, price, image, collection FROM addtocart.store_products");
            $js_items = [];
